            ...
            <div className={size > 800 ? 'contact' : 'contactSmall'}>
                ...
                <div className={size > 800 ? 'contactInfo' : 'contactInfoSmall'}>
                    <div>
                        ...
                        <div className={size > 800 ? "content" : size > 500 ? "contentSmall" : 'vContentSmall'}>Academic Building, 2nd Floor
                            IIIT,
                            Okhla Phase -III, New Delhi - 110020</div>
                    </div>
                    <div>
                        <div className={size > 800 ? 'sub' : size > 500 ? 'subSmall' : 'vSubSmall'}>Contact Info</div>
                        <div className={size > 800 ? "content" : size > 500 ? "contentSmall" : 'vContentSmall'}>011-26907 400</div>
                    </div>
                    <div>
                        <div className={size > 800 ? 'sub' : size > 500 ? 'subSmall' : 'vSubSmall'}>Mail Info</div>
                        <div className={size > 800 ? "content" : size > 500 ? "contentSmall" : 'vContentSmall'}>admin-academics@iiitd.ac.in</div>
                    </div>
                </div>
            </div>
        </div >
