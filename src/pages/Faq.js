            ...
            <div>
                {registration ?
                    <div id='cr'>
                        ...
                        <div className='que'>
                            <ol>
                                <li><div className='question'>How should we plan for taking courses? </ div>
                                    <div className='answer'>Should consult the concerned program coordinator before pre-registration</div></li>
                                <li><div className='question'>If we wish to take two courses, however in the time table both the courses are clashing, whom should we request?</ div>
                                    <div className='answer'>Student Senate</ div></li>
                                <li><div className='question'>If a few important courses are not offered, however these courses satisfy the core/bucket or specialization requirement, whom should we request to explore the possibility of offering the course?</ div>
                                ...
                                <li><div className='question'>Are we allowed to register IP and IS together in a semester?</ div>
                                <div className='answer'>                                    Allowed</div></li>
                                <li><div className='question'>Are we allowed to register IP/IS under visiting Faculty?</ div>
                                <div className='answer'>Allowed)</div></li>
                                <li><div className='question'>Are we allowed to register IP/IS under Guest Faculty?</ div>
                                <div className='answer'>Allowed only when the Guest faculty is taking a course in the same semester</div></li>
                                <li><div className='question'>Are we allowed to register IP/IS under Adjunct Faculty?</ div>
                                <div className='answer'>No</div></li>
                                <li><div className='question'>Can we give improvement exam in courses?</ div>
                                ...
                                <li><div className='question'>When can we replace a course?</ div>
                                ...
                                <li><div className='question'>How many credits a student should have registered to be eligible to replace a course?</ div>
                                ...
                                <li><div className='question'>What does replacement of a course means?</ div>
                                ...
                                <li><div className='question'>How do we request to replace a course after publication of results?</ div>
                                <div className='answer'>Fill the form available on our website and submit it to admin-mtech</div></li>
                                <li><div className='question'>How do we request to replace a course at the time of graduation, after completion of all my credits?</ div>
                                ...
                                <li><div className='question'>Is it mandatory to replace a course if we have done additional courses?</ div>
                                ...
                                <li><div className='question'>Can we replace core course in a specialization?</ div>
                                <div className='answer'>Allowed, only with a core course</div></li>
                                <li><div className='question'>Can we replace specialization elective?</ div>
                                <div className='answer'>Allowed, only with a specialization elective</div></li>
                                <li><div className='question'>Are we allowed to replace a regular in-class course with IP/IS?</ div>
                                <div className='answer'>No</div></li>
                                <li><div className='question'>Are we allowed to do online courses? If yes, then how?</ div>
                                <div className='answer'>[Yes, but only as Independent study (IS)]</div></li>
                                <li><div className='question'>Where can we find the description of courses?</ div>
                                ...
                                <li><div className='question'>Are we allowed registering SSH or courses of other departments?</ div>
                                <div className='answer'>Yes</div></li>
                                <li><div className='question'>When can we take IP/IS?</ div>
                                <div className='answer'>Any term as far as the guide/advisor allows</div></li>
                                <li><div className='question'>When and how taking overload is allowed in each semester?</ div>
                                <div className='answer'>Overload is allowed after 1st semester if CGPA{'>'}=8</div></li>
                                <li><div className='question'>Do we need to take approval for overload if our CGPA{'>'}= 8?</ div>
                                ...
                                <li><div className='question'>Is it necessary to complete the bucket courses in first year only?</ div>
                                ...
                                <li><div className='question'>Does IP/IS have to be from the same domain as the specialization?</ div>
                                <div className='answer'>Not necessary</div></li>
                                <li><div className='question'>Can the projects (IP/IS) be done in groups?</ div>
                                <div className='answer'>It depends upon the guide/advisor </div></li>
                                <li><div className='question'>Can we sit through a course and not register it on ERP?</ div>
                                <div className='answer'>Yes, you can with the permission of Instructor</div></li>
                                <li><div className='question'>How can we register a course as Audit?</ div>
                                ...
                                <li><div className='question'>Are we allowed to convert a course registration from audit to credit or vice versa?</ div>
                                <div className='answer'>No</div></li>
                                <li><div className='question'>What is late drop?</ div>
                                ...
                                <li><div className='question'>What is Project Registration?</ div>
                                ...
                                <li><div className='question'>If we are working on a Thesis/CapP/SP which is continued from last semester; do we still have to do the project registration?</ div>
                                ...
                                <li><div className='question'>How does the summer registration happen?</ div>
                                ...
                                <li><div className='question'>If a course has pre-requisites which as  M.Tech. students we have not completed here at IIITD, however we have required background from our previous institute; how to proceed for registration?</ div>
                                <div className='answer'>Contact your instructor and seek his/her approval to register for this</div></li>
                                <li><div className='question'>We are not able to register few courses which are visible in ERP?</ div>
                                ...
                                <li><div className='question'>There is a lack of IP/Cap under most of the professors and hence we are unable to complete the internship requirement of 32 credits until summer term. Whom to approach?</ div>
                                <div className='answer'>Approach the respective HOD</div></li>
                                <li><div className='question'>Are there any credits for doing internship?</ div>
                                <div className='answer'>No</div></li>
                                <li><div className='question'>Can we register for a course or project while on an internship?</ div>
                ...
                {specialisation ?
                    <div id='spz'>
                        ...
                        <div className='que'>
                            <ol>
                                <li><div className='question'>Where can we find the specialization requirements?</ div>
                                ...
                                <li><div className='question'>Can we switch between program i.e. M.Tech. (CSE) to M.Tech. (ECE) / M.Tech (CB) or vice versa?</ div>
                                <div className='answer'>No</div></li>
                                <li><div className='question'>If we are doing  Thesis/SP in a domain other than our specialization, then are we eligible for that specialization ?</ div>
                                <div className='answer'>No</div></li>
                                <li><div className='question'>If we are not opting for Thesis/SP/CapP, are we eligible for specialization? </ div>
                                <div className='answer'>Not for all porgrams, allowed only in ECE (CPS & ML) </div></li>
                                <li><div className='question'>Can AI specialization student obtain the without specialization degree by doing general core courses buckets?</ div>
                                <div className='answer'>Yes, check the regulations for details</div></li>
                                <li><div className='question'>Can one course fulfill both specialization and bucket requirements? </ div>
                ...
                {thesis ?
                    <div id='tsc'>
                        ...
                        <div className='que'>
                            <ol>
                                <li><div className='question'>Can we switch between Thesis/ SP? </ div>
                                <div className='answer'>Conversion of SP to Thesis and vice versa is allowed</div></li>
                                <li><div className='question'>What is the process of conversion of Thesis to SP and vice versa? </ div>
                                <div className='answer'>By sending an email to admin-mtech with the approval of supervisor</div></li>
                                <li><div className='question'>What will happen to the registered credits with grades of Thesis if it is converted to SP? </ div>
                                ...
                                <li><div className='question'>Is internal guide necessary when registering with an Adjunct faculty? </ div>
                                ...
                                <li><div className='question'>Are we allowed to register for Thesis/ SP/ CapP during the internship? </ div>
                                <div className='answer'>No</div></li>
                                <li><div className='question'>How can we change our supervisor? </ div>
                                <div className='answer'>Yes, by filling the Supervisor Change Form</div></li>
                                <li><div className='question'>Can we register Thesis after Capstone project or vive versa? </ div>
                                <div className='answer'>Yes, with approval from AAC. However, earned credit will not be transferred</div></li>
                                <li><div className='question'>Do the grades of both Thesis & Capstone calculated in CGPA, if we consider only Thesis as a part of graduation requirement? </ div>
                                <div className='answer'>Yes</div></li>
                                <li><div className='question'>Is there any deadline for Thesis defense and submission of report for SP/ IndP/ CapP? </ div>
                                <div className='answer'>As per Academic Calendar & guidelines</div></li>
                                <li><div className='question'>How can we opt for Capstone Project? </ div>
                                <div className='answer'>You need to search on your own, approach IIITD faculty member with mutual research interest</div></li>
                                <li><div className='question'>When an "I" grade in Thesis is to be converted to "S/X"? </ div>
                                <div className='answer'>One month after the completion of the semester</div></li>
                                <li><div className='question'>How is the grading done for Thesis/CapP/SP. </ div>
                                ...
                                <li><div className='question'>Do we need to tell beforehand which option (with thesis or without thesis) are we choosing? </ div>
                                <div className='answer'>It is implied as you are doing the registration in ERP</div></li>
                                <li><div className='question'>Can we only register for projects (IP/IS/Thesis/CapP/SP) and not any course in a semester? </ div>
                                ...
                                <li><div className='question'>Can projects (Thesis/CapP/SP) be done in groups? </ div>
                                ...
                                <li><div className='question'>Are we allowed to opt for Thesis and Capstone in a semester? </ div>
                                <div className='answer'>No</div></li>
                            </ol>
                        </div>
                    </div> : null}
                {intern ?
                    <div id='internship'>
                        ...
                        <div className='que'>
                            <ol>
                                <li><div className='question'>How can we go for an internship? </ div>
                                ...
                                <li><div className='question'>What is student interaction? </ div>
                                ...
                                <li><div className='question'>Can a GATE admit drop TAship? </ div>
                                <div className='answer'>TAship is mandatory for GATE admits</div></li>
                                <li><div className='question'>Is there a minimum requirement of course work? </ div>
                                <div className='answer'>Yes, see the regulations for details</div></li>
                                <li><div className='question'>Is there any maximum credits limit that can be registered in whole M.Tech program? </ div>
                                <div className='answer'>No</div></li>
                                <li><div className='question'>Are we eligible to get the degree if we got an X in TAship? </ div>
                                <div className='answer'>Yes, but not eligible for Internship</div></li>
                                <li><div className='question'>Are we eligible to get t the degree if we  drop TAship? </ div>
                                <div className='answer'>Yes, but not be eligible for Internship</div></li>
                                <li><div className='question'>Are we allowed to sit for FTE placement roles if we drop TAship? </ div>
                                <div className='answer'>Yes</div></li>
                                <li><div className='question'>Are we allowed to sit for FTE placement roles if we get an X in TAship? </ div>
                                <div className='answer'>Yes</div></li>
                            </ol>
                        </div>
                    </div> : null}
                {graduation ?
                    <div id='gr'>
                        ...
                        <div className='que'>
                            <ol>
                                <li><div className='question'>What is the credit requirement for M.Tech Degree? </ div>
                                <div className='answer'>48 Credit, see regulations for details</div></li>
                                <li><div className='question'>What is the minimum CGPA requirement for graduation? </ div>
                                <div className='answer'>6.5</div></li>
                                <li><div className='question'>Are we allowed to do more credit than the minimum requirement? </ div>
                                <div className='answer'>Yes</div></li>
                                <li><div className='question'>What is the maximum time to complete M.Tech. Degree? </ div>
                                <div className='answer'>No Upper Limit</div></li>
                                <li><div className='question'>Does 300-400 level courses get counted towards 48 credits requirement for all specialization? </ div>
                                <div className='answer'>Yes, up to certain limit, read the regulation to know the limit</div></li>
                                <li><div className='question'>In case of plagiarism/F/low cgpa in a course, is it required to re-take that course for improvement? </ div>
                                <div className='answer'>Not necessary, but you have to  fulfill all the requirements</div></li>
                                <li><div className='question'>If we have completed the credit requirement, however only thesis defense is pending; what should we register in a semester? </ div>
                ...
                {operation ?
                    <div id='opr'>
                        ...
                        <div className='que'>
                            <ol>
                                <li><div className='question'>Where can we get Identity Card/ Access Card? </ div>
                                <div className='answer'>Contact Admin-M.Tech</div></li>
                                <li><div className='question'>How to get email id login and password? </ div>
                                <div className='answer'>Approach Admin-M.Tech</div></li>
                                <li><div className='question'>What is the minimum SGPA/CGPA to avail Stipend? </ div>
                                <div className='answer'>6.0</div></li>
                                <li><div className='question'>What is the minimum SGPA/CGPA to continue the program? </ div>
                                <div className='answer'>6.0</div></li>
                                <li><div className='question'>How can we reset our password of Email id? </ div>
                                <div className='answer'>Approach IT Help Desk; <a href="mailto:it-helpdesk@iiitd.ac.in" >it-helpdesk@iiitd.ac.in</a></div></li>
                                <li><div className='question'>How to get ERP login ID & Password? </ div>
                                <div className='answer'>Approach Admin-M.Tech</div></li>
                                <li><div className='question'>How can we reset our password of ERP? </ div>
                                <div className='answer'>Clink on the forgot password link available on the home page of ERP</div></li>
                                <li><div className='question'>Where to apply for internet access? </ div>
                                <div className='answer'>Approach IT Help Desk; <a href="mailto:it-helpdesk@iiitd.ac.in" >it-helpdesk@iiitd.ac.in</a></div></li>
                                <li><div className='question'>What is the basis of hostel allotment? </ div>
                                <div className='answer'>Depends upon availability, for more info contact Student Affairs office</div></li>
                                <li><div className='question'>Are we (Day Scholar) allowed in Hostel during examination? </ div>
                                <div className='answer'>Upon prior approval & Availability; contact student affair office</div></li>
                                <li><div className='question'>How to get transcript & other certificate? </ div>
                                <div className='answer'>Approach Admin-M.Tech</div></li>
                                <li><div className='question'>How to get bonafide certificate? </ div>
                                <div className='answer'>Approach Admin-M.Tech</div></li>
                                <li><div className='question'>When can we get a provisional certificate? </ div>
                                <div className='answer'>Approach Admin-M.Tech</div></li>
                                <li><div className='question'>Is there any certificate given for TAship as Experience? </ div>
                                ...
                                <li><div className='question'>What is the procedure of withdrawal? </ div>
                                <div className='answer'>Approach Admin-M.Tech</div></li>
                                <li><div className='question'>Do we have to pay the semester fees during internship? </ div>
                                <div className='answer'>Yes if any installment is left, there is fixed time line for payment of fees</div></li>
                                <li><div className='question'>What is the process left after Thesis Defense and Submission of report? </ div>
                                <div className='answer'>You need to complete other administrative formalities which will be informed by admin-mtech</div></li>
                                <li><div className='question'>What is the leave policy for M.Tech student?</ div>
                                ...
                                <li><div className='question'>What is digital attendance? </ div>
                                ...
                                <li><div className='question'>What is AICTE-DBT? </ div>
                                <div className='answer'>Payment of M.Tech stipend directly from AICTE</div></li>
                                <li><div className='question'>How can we become a member of  student council/Student Senate? </ div>
                                <div className='answer'>Apply when student council/student senate nominations are rolled out</div></li>
                                <li><div className='question'>Is there any specific credit requirement to be eligible for placement drive? </ div>
                                <div className='answer'>Consult Training and Placement for more clarification</div></li>
                                <li><div className='question'>Is there any specific CGPA requirement to be eligible for placement drive? </ div>
